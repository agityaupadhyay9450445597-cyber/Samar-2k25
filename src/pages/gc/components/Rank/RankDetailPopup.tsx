        ...
        >
            ...
            >
                ...
                <p className="text-lg mb-5 text-gray-800 font-medium">
                    <span className="font-bold text-teal-600">Overall Rank: #{team.rank}</span> | 
                    <span className="ml-2 font-bold text-teal-600">Total Points: {team.overallPoints}</span>
                </p>

                {/* Points by Sport */}
                <h4 className="text-xl font-semibold mb-4 text-gray-700 tracking-wide">Points Acquired by Sport:</h4>
                ...
                <ul className="space-y-3 max-h-72 overflow-y-auto pr-2">
                    {team.distributedPoints.map((sport, index) => (
                        ...
                        >
                            <span className="font-medium text-gray-800">{sport.sportName}</span>
                            <span className="font-bold text-lg text-teal-700">{sport.points} pts</span>
                        </li>
                    ))}
                </ul>
